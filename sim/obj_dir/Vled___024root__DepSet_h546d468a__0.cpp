...
void Vled___024root___nba_sequent__TOP__0(Vled___024root* vlSelf);
...
VL_INLINE_OPT void Vled___024root___nba_sequent__TOP__0(Vled___024root* vlSelf) {
    ...
    if ((0xaU <= vlSelfRef.top__DOT__counter)) {
...
#endif
            VL_FATAL_MT("../src/combinational/led.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("../src/combinational/led.v", 1, "", "Active region did not converge.");
            }
